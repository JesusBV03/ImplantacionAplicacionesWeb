...
<form name="datos" action="u_borrar_2.php" method="POST">

    <table>
        <tr>
            <td>Usuario ID:</td>
            <td><input type="number" name="usuario_id" id="usuario_id" placeholder='Usuario ID'></td>
            
        </tr>
        <tr>
            <td>Mail:</td>
            <td><input type="text" name="correo" id="correo" placeholder='Mail'></td>
...
<?php
    ...
    $query = "select usuario_id,nombres,correo,clave,tipo_usuario from usuario";
    ...
    /* Mostrar la tabla en pantalla de los usuarios. */
        ...
        echo "<fieldset>";
        echo "<legend>Lista Usuarios</legend>";
        echo "<table class='tab_listar'>";
        echo "<tr class='borde'><td class='borde'>Usuario ID</td><td class='borde'>Nombre</td><td class='borde'>Mail</td><td class='borde'>Password</td><td class='borde'>Tipo Usuario</td></tr>";
        
        for($i=0; $i<$nfilas; $i++){
            $row=mysqli_fetch_assoc($listar);
            echo "<tr><td class='borde'>".$row['usuario_id']."</td><td class='borde'>".$row['nombres']."</td><td class='borde'>".$row['correo']."</td><td class='borde'>".$row['clave']."</td><td class='borde'>".$row['tipo_usuario']."</td></tr>";
        }
        echo "</table>";
        echo " </fieldset>";
    }
        ...
        echo"<br><br><br>";
        echo "<div><span class='add_2'>No hay usuarios en la base de datos</span></div>";
