...
<header>
    ...
    <main>
        ...
        /* query */
        $precio_final_compra=$_SESSION['precio_final_compra'];
        $codigo_piso_compra=$_REQUEST['compra'];
        $usuario_id_compra=$_SESSION['usuario_id'];

        $query = "insert into comprados (usuario_comprador,codigo_piso,precio_final) values ('$usuario_id_compra','$codigo_piso_compra','$precio_final_compra')";
        ...
        if(mysqli_query($conexion,$query)) {
            echo "<fieldset>";
            echo "<legend>Compra Piso</legend>";
            echo "<span  class='add_2'>Piso Comprado, gracias</span>";
            echo "</fieldset>";
        }
