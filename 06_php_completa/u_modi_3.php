...
<header>
    ...
    <main>
        ...
        $clave_encriptada = md5(sha1($clave));
        ...
        $query = "update usuario set usuario_id='$id',nombres='$nombre', correo='$correo', clave='$clave_encriptada', tipo_usuario='$tipo' where nombres='$nombre' or correo='$correo'";
        ...
        if (mysqli_query($conexion, $query)) {
            echo "<br><br><br>";
            echo "<span class='add_1'> Actualizado " . $nombre . "</span>";
